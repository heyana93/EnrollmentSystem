<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true"
    CodeFile="ChangeTerms.aspx.cs" Inherits="Student_Terms_Terms" %>

<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="Server">
    <article>
        <h2>
            Zapisy na zajęcia</h2>
        <p>
            Kod kursu:
            <asp:TextBox ID="tc" runat="server" Width="100px"></asp:TextBox>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:CommandField ButtonType="Button" EditText="Zapisz" ShowCancelButton="False"
                        ShowEditButton="True" HeaderText="Opcje" />
                </Columns>
