<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true" CodeFile="MyProfile.aspx.cs" Inherits="Instructor_MyProfile" %>
    ...
    <article>
        ...
        <p>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:zapisyConnectionString %>"
                SelectCommand="Instructor_Sel_ByUserName" SelectCommandType="StoredProcedure" UpdateCommand="Instructor_Upd_ByUserName"
